# -*- coding: utf-8 -*- 
"""
@Time        : 2020/5/29 16:23 
@Author      : tmooming
@File        : config.py 
@Description : TODO
"""

FUTURES = ['AL', 'CU', 'RU', 'A', 'WT', 'M', 'WS', 'CF', 'FU', 'C', 'B', 'SR', 'Y', 'TA', 'ZN', 'RO', 'L', 'P', 'AU',
           'RB', 'WR', 'ER', 'V', 'IF', 'PB', 'J', 'ME', 'PM', 'AG', 'OI', 'RI', 'WH', 'FG', 'RM', 'RS', 'JM', 'TF',
           'TC', 'BU', 'I', 'JD', 'JR', 'BB', 'FB', 'PP', 'HC', 'MA', 'LR', 'SF', 'SM', 'CS', 'T', 'NI', 'SN', 'IC',
...
WORDS = ['2008 financial crisis', 'blizzard', 'China unemployment rate', 'climate change', 'cold', 'cold wave',
         ...
         'Syria war', 'terrorism', 'terrorist attack', 'tornado', 'typhoon', 'unemployment', 'Unemployment benefits',
         'unemployment rate']
